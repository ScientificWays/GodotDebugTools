...
const _CONSOLE_COMMAND: GDScript = preload("res://addons/GodotDebugTools/GDconsole/ConsoleCommand.gd")

const _NORMAL_FONT: FontFile = preload("res://addons/GodotDebugTools/GDconsole/fonts/JetBrainsMono-Regular.ttf")
const _BOLD_FONT: FontFile = preload("res://addons/GodotDebugTools/GDconsole/fonts/JetBrainsMono-Bold.ttf")
